...
\lstdefinelanguage{tutorialD}{
  morekeywords={\ , \}, \{, var, operator,with,as,end},
  sensitive=false,
%  morecomment=[l]{//},
%  morecomment=[s]{/*}{*/},
%  morestring=[b]",
...
\lstdefinestyle{tutorialD}{
        ...
        emph={tuple,relation,base,key,same_type_as,same_heading_as,return,returns,from,%
%          where,rename,union,join,minus,extend,add,
        },
