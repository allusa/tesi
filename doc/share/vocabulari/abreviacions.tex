...
\newglossaryentry{SGST}{type=\acronymtype, name={SGST}, description={sistema de gestió de base de dades per a sèries temporals (\emph{Time Series Data Base Management System})}, text={\acro{SGST}}, first={sistema de gestió de base de dades per a sèries temporals (\acro{SGST})},firstplural={sistemes de gestió de bases de dades per a sèries temporals (\acro{SGST})}, plural={SGST}}
...
\newglossaryentry{BDSTM}{type=\acronymtype, name={BDSTM}, description={base de dades per a sèries temporals multiresolució (\emph{Multiresolution Time Series Data Base})}, text={\acro{BDSTM}}, first={base de dades per a sèries temporals multiresolució (\acro{BDSTM})},firstplural={bases de dades per a sèries temporals multiresolució (\acro{BDSTM})}, plural={BDSTM}}
