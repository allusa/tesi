...
%anglès
\newacronym[see=SGBD]{DBMS}{DBMS}{\emph{Data Base Management System}}
\newacronym[see=SGBDR]{RDBMS}{RDBMS}{\emph{Relational Data Base Management System}}

\newacronym[see=SGSTM]{MTSMS}{MTSMS}{\emph{Multiresolution Time Series Data Base management system}}
\newacronym[see=SGST]{TSMS}{TSMS}{\emph{Time Series Data Base management system}}
