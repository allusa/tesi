...
%--------------------
\documentclass[paper=a4,fontsize=11pt,parskip=half,
twoside, BCOR12mm,
%oneside, %%format web
% twoside,openany,DIV = 10,BCOR12mm, %%format en paper
]{scrbook}
...
%% The \operatorname and \operatorname* commands[1] display a custom operators, the * version sets the underscored option underneath like the \lim operator
%-------------- dades --------------------------
\hypersetup{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
% Memòria Tesi Doctoral. Model dels sistemes de gestió de bases de dades per sèries temporals.
%
