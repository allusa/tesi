...
\begin{tikzpicture}[scale=\escala]
  \draw[filled] \firstcircle \nodeA;
   ...
   \node[anchor=south] at (current bounding box.north) {$R \cup S$};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=\escala]
  \draw[filled] \secondcircle \nodeB;
   ...
   \node[anchor=south] at (current bounding box.north) {$S \cup R$};
\end{tikzpicture}
%Set temporal A or B
...
\begin{tikzpicture}[scale=\escala]
    \draw[filled, even odd rule] \firstcircle \nodeA
                                 \secondcircle \nodeB
                                 \thirdcircle \nodeT;
    \node[anchor=south] at (current bounding box.north) {$R \cup^t S$};
\end{tikzpicture}
