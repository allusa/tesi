...
preliminaries, %mainly about measures and time series;
sec.~\ref{sec:MTSMS} defines the data
structure, %the main part of the model;
and sec.~\ref{sec:model:interpolador} extends for summarising
operators%, which we call attribute aggregate functions
...
MTSMS model proposal.% and we consider some future working directions.
