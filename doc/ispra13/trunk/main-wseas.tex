...
isbn=false,url=false,doi=false,eprint=false,alldates=terse,firstinits=true,abbreviate=true, %%format en paper
}
...
\renewbibmacro*{title}{%
      \printtext[title]{\printfield[sentencecase]{title}}
}
...
%http://tex.stackexchange.com/questions/18820/how-to-make-cross-referencing-with-shorthands
