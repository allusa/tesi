...
studied \todo{see graham or deri}. However, treating time series as
...
Time series as data streams are also considered when aggregating statistically data in order to do fast approximate queries with compressed data. \todo{graham}
