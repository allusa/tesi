...
Parla de sketch, que són els algoritmes per calcular mitjançan orientació a flux (stream). Això es pot aplicar al model de MTSMS: la $S_B$ esdevé de cardinal 1 i les $f$ queden restringides a aquelles que es poden calcular en flux. De fet, és el patró que segueix RRDtool.
