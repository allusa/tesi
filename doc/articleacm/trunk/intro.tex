...
(\acro{TSMS}), \cite{dreyer94}.  We introduce a new data model named
...
\acro{TSMS} are introduced. The \acro{MTSMS} model is presented in
Section~\ref{sec:MTSMS} and in Section~\ref{sec:M+TSMS} the relation
between \acro{MTSMS} and \acro{TSMS} models is highlighted.
...
\item Data validation. Monitoring systems capture data but can occur
  ...
  data, known as gaps, or capture data erroneously, such as outlayers \todo{ref}.
