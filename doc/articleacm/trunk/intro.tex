...
A representation function concept of time series is formalised, then
...
\cite{dreyer94} propose the requirements of special purpose \acro{TSMS} and
...
research in \acro{DBMS} models bitemporal data as relations extended
...
attribute aggregate functions in the \acro{MTSMS} model, as instance it
...
more weight to recent information.  Our \acro{MTSMS} model applies a similar
...
analysis of a \acro{TSMS} called RRDtool \cite{rrdtool}. Our objective is to
