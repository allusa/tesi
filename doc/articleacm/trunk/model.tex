...
this increase is due to a time ordered acquisition of data which can
be taken into account in order to simplify the addition process. As a consequence we can design TSMS with a simplified  update operation where it only consists in adding new measures as there is no need for modifying past data.
