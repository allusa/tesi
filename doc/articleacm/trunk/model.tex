...
projectively extended real numbers $\R* \in \R \cup \{\infty\}$.
...
\todo{repensar la relacio d'ordre}
\todo{potser: total order = temporal order; partial order = order}
...
\todo{multivalor}
mesura multivaluada o time series multivaluada
En aquest exemple amb reals, el valor  ́s un escalar per` f`cilment es pot estendre
e
o a
el concepte a valors multivaluats R∗ n que representin una col.lecci ́ de valors me-
o
surats en el mateix instant de temps, tal i com fa per exemple assfalg08:thesis,
[assfalg08:thesis].
...
\]
\[
\multiresolution(S) = \fold(S_\delta,\{\},f_c,\min) \text{ where }
\]
\[
...
% LocalWords:  pathologies MTSMS TSMS cardinality
