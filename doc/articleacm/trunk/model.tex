...
coherent treatment. We describe the TSMS model in three parts: (i) the
data structure model, (ii) time series manipulation and operation, and
(iii) time series specific properties.
...
\todo{explicar que per exemple en la unio de conjunts tradicional tenim problemes quan tenim una m1=(t,v1) i una m2=(t,v2) i ho podem solucionar amb dues unions}
\todo{treure el dibuix de conjunts i fer nomes un exemple concret amb dades en el cas de la unio}
