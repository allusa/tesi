...
Next we show a real example database for a time series data using
Pytsms and RoundRobinson implementations. Actual data comes from a
temperature distributed sensor monitoring system \cite{alippi10}, we
focus on one sensor data.
...
with \zohe{} representation function $S(t)^\zohe{}$. Time axis has \acro{UTC} units
