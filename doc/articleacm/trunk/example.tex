...
with \zohe{} representation function. Time axis has \acro{UTC} units
...
\end{figure}
\todo{cal que hi hagi el total pel mean i pel max}
...
\todo{seriedisc is regular}
\todo{totalseries is not regular nut is regular a trossos}
