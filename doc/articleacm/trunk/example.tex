...
\begin{figure}[tp]
  ...
  %\includegraphics{fig/fig_exemple_original}
...
\begin{figure}[tp]
  ...
  %\includegraphics{fig/fig_exemple_window}
...
\begin{figure}[tp]
  ...
  % \includegraphics{fig/fig_exemple_4mrd1}
  % \includegraphics{fig/fig_exemple_4mrd2}
  % \includegraphics{fig/fig_exemple_4mrd3}
  % \includegraphics{fig/fig_exemple_4mrd4}
...
\begin{figure}[tp]
  ...
  %\includegraphics{fig/fig_exemple_4mrdtot}
