...
{inline}
{}
\pagenumbering{arabic}   %%%per poder veure les pagines mentrestant
...
\keywords{Time series, database systems, multiresolution, lossy compression, approximate queries} % NOT required for Proceedings
