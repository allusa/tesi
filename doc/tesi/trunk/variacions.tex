...
(\seeref{sec:model:sgstm}) llevat que hi ha buffers que
...
més profund que l'estructura general i no es pot aplicar sempre. \todo{algun exemple?}
...
\subsection{Agregacions amb orientació a flux}
