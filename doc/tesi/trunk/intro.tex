...
\textref{cap:estat} d'aquesta memòria, hi ha multitud de metodologies
...
\item Article a \emph{Information Systems} \parencite{llusa16:is}
  ...
  article es publicarà a la revista \emph{Information Systems} del
  març de 2016 tot i que ja es troba disponible en línia a la mateixa
  revista.

\item Les implementacions són de programari lliure i es poden trobar a
  \cite[\url{http://escriny.epsem.upc.edu/projects/rrb/repository/show/src}]{llusa:implementacions}. Tot
