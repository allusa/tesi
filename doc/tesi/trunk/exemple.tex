...
4. 1,43 minuts  (provat amb un mean i max directe) ->erronis
5. 1,48 minuts  (provat amb un mean i max directe)->erronis
6. 1,42 minuts  (provat amb un mean i max directe)->erronis
7. 1,43 minuts  (provat amb un mean i max directe)->erronis
...
8. 1,31 minuts (provat amb un mean i max directe)->erronis
9. 1,33 minuts (provat amb un mean i max directe)->erronis
10. 1,35 minuts (provat amb un mean i max directe)->erronis
11. 1,31 minuts (provat amb un mean i max directe)->erronis
