...
que és el \gls{UTC}.  Ambdós estàndards assenyalen el instants de
...
en el les mesures d'\gls{UTC}. L'Hora Unix és l'estàndard de temps
...
l'apartat anterior hem definit el domini temps de manera general amb
el conjunt de reals, els quals exemplifiquen més clarament el concepte
...
\begin{definition}[Sèrie temporal]
  ...
  de mesures $S=\{m_0\glsdisp{not:coma}{,}\ldots,m_k\}$ en què no hi ha temps repetits
  $\forall i,j\glsdisp{not::}{:} i\leq k, j\leq k, i\neq j : T(m_i)\neq T(m_j)$.
\end{definition}
...
\glspl{SGBDR}\todo{ref al capítol d'art de sgbd}, a continuació
