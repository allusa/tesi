...
\begin{frame}{Estat actual i motivació}
  ...
  \item Multitud de tècniques d’anàlisi de sèries temporals, representacions aproximades òptimes: cal poder-les integrar en els SGBD %(candidats a funcions d’agregació)
...
\begin{columns}
  ...
  \item Model relacional: teoria de conjunts (àlgebra relacional) o lògica de predicats (càlcul relacional)
  \item Tradició en els SGBD: SQL. Evolució recent: NoSQL, NewSQL, The Third Manifesto, \parencite{date:thethirdmanifesto}, \emph{One size does not fit all} \parencite{stonebraker09}
  \end{itemize}
...
%%% TeX-master: "defensa"
%%% End: 
%  LocalWords:  multiresolució SGBD Precomputació bitemporals
