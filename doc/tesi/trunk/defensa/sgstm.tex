   ...
   \begin{tikzpicture}[scale=0.7, every node/.style={transform shape}]
    ...
    \addplot[red,only marks, mark = *] coordinates {
        ...
        (45,8)
          ...
          \node[right] at (axis cs:30,8) {$m_1$};
          \node[left] at (axis cs:40,5) {$m_2$};
          \node[left] at (axis cs:50,8) {$m_3$};
    \end{axis}
  \end{tikzpicture}
...
\column{6cm}
  \begin{tikzpicture}[scale=0.7, every node/.style={transform shape}]
    ...
    \addplot[lightgray,only marks, mark = *] coordinates {
        (19,4)
        (35,2)
        (43,5)
        (45,8)
          ...
          \addplot[only marks,mark=*,lightgray] coordinates {
            (30,8)
            (40,5)
            (50,8)
          };
          ...
          \node[right, lightgray] at (axis cs:30,8) {$m_1$};
           \node[left, lightgray] at (axis cs:40,5) {$m_2$};
           \node[left, lightgray] at (axis cs:50,8) {$m_3$};

          \node[above] at (axis cs:22,6) {$a$};
          \node[above] at (axis cs:25,7) {$b$};
          \node[above] at (axis cs:28,8) {$c$};
...
\end{columns}
  ...
  \begin{enumerate}
    ...
    \item Encara no es pot consolidar
  \end{enumerate}
...
\end{columns}
  ...
  \begin{enumerate}
    \setcounter{enumi}{2}
    \item Afegeix una mesura següent a $\tau+\delta$

    \item Calcula la mesura resultant $m_1=f(\{a,b,c,d\},\tau,\delta)$
...
\vphantom{Consolidació:}
  ...
  \begin{enumerate}
      \setcounter{enumi}{6}
\item Repeteix la consolidació pel nou interval

\item (Controla el cardinal del disc)
