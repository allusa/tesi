...
\begin{example}[Sèrie temporal amb tret de seqüència agregada]
  ...
  temps dens.  Encara que aquest i casos semblants compleixen les
...
\begin{definition}[Sèrie temporal de temps real]
  ...
  durada de temps i $e$ una durada que indica termini. La sèrie
  temporal $S$ és de temps real si i només si $e\leq d$ i la
...
compliment del termini $e$.  Si $e=d$, es pot anomenar que $S$ és
