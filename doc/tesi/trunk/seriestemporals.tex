...
L'objectiu d'aquest apartat és mostrar l'estat de l'art dels
...
Actualment, les sèries temporals es consideren com un dels deu
...
\begin{figure}[tp]
  \begin{center}
    \scriptsize 
    \input{imatges/intro/monitoratge.tex}
  \end{center}
