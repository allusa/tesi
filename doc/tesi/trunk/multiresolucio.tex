...
\[
M'_0=\glssymbol{consolidaM}(M_k),\dotsc,M'_{l}=\glssymbol{consolidaM}(M'_{l-1}),M'=\glssymbol{consolidaM}(M'_{l})
\]
on $M_k,M'_{0},\dotsc,M'_{l-1},M'_{l}$ són consolidables i $M'$ no és
consolidable.  
