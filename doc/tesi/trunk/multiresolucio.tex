...
\begin{enumerate}
\item Primer, s'afegeixen totes les mesures de la sèrie temporal a la sèrie temporal
multiresolució, $\forall m \in S:$
\[
M_0=\glssymbol{addM}(M,m_0),M_1=\glssymbol{addM}(M_0,m_1),\dotsc,M_k=\glssymbol{addM}(M_{k-1},m_k)
\]

\item Segon, es consolida la sèrie temporal multiresolució fins que no sigui
...
\item Tercer, es consulta la sèrie temporal multiresolució amb les dues
