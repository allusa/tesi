...
\todo{ potser seria millor explicar-ho allà: No ocorre perquè ja es crea el conjunt TI inicialment, però potser es podria comentar en el context de computació diferida}
...
\item No es tenen en compte els cardinals màxims. Si es volen tenir en
  ...
  zero. \label{def:mapreduce:ajustamentdetaus} \todo{s'hauria de dir que hem introduït aquesta funcionalitat a RoundRobinson}
