...
\renewcommand{\glossarypreamble}{Taula de notació segons nom, símbol i
  referència on es defineix --definició, secció (\S) o exemple
  (ex.). Organitzada en símbols matemàtics i notació de
  \gls{SGST} i \gls{SGSTM}, aquests darrers també organitzats per
  components.\\[2ex]}
