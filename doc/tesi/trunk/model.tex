...
pels \gls{SGBD} de la~\autoref{sec:art:sgbd} amb el model que
proposem. Segon, introduïm el context i els supòsits que utilitzarem a
l'hora de treballar amb les sèries temporals.  Tercer, introduïm les
...
En la~\autoref{sec:art:sgbd} s'han nombrat els tres nivells
...
\todo{}
  ...
  Per una banda, cal destacar, des de l'asusmpció/supòsit/context de la interpretació en el monitoratge,
...
\paragraph{Sèries temporals vs. senyals digitals}
\todo{}

Les sèries temporals s'utilitzen en teoria del senyal. En l'anàlisi que es duu a terme en aquest àmbit, però, ...
