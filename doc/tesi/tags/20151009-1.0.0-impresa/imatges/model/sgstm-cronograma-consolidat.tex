...
\begin{tikzpicture}
 ...
 %R1 d2 k4 tau0 f-1
  ...
  \node[ellipse,draw,minimum width=\ut cm] (R1b) [left=0mm of R1.center, anchor=east] {$S_{B2}$};
  ...
  %R0 d1 k4 tau0
  \node (R0) [above=2.3cm of R1.center] {};
%  \node[ellipse,draw,minimum width=\ut cm,align=center] (R0b) [left=0mm of R0.center, anchor=east] {$S_{B1}$};
  \node[rectangle,draw,minimum width=\ut cm,align=center] (R0d1) [left=0mm of R0.center, anchor=east] {$S_{D1}^1$};
  ...
  \draw[<->] (R0la) -- (R0lb) node [above,sloped,midway] {$\glssymbol{not:sgstm:lapseR}(R_1)$};
 ...
 \node (R0ba) [above=5mm of R0d1.east] {};
 \node (R0bb) [right=\ut of R0ba.west] {};
 \draw[<->] (R0ba) -- (R0bb) node [above,sloped,midway] {$\glssymbol{not:sgstm:lapseB}(R_1)$};
 ...
 \node (R1lba) [above=12mm of R1d1.east] {};
 ...
 \draw[<->] (R1lba) -- (R1lbb) node [above,sloped,midway] {$\glssymbol{not:sgstm:lapseB}(R_2)$};
  ...
  \node (tau0d) [below=0mm of 0] {$\tau_1$};
  \node [below=0mm of tau0d] {$\tau_2$};
  \node [below=0mm of 1] {$\tau_1+\delta_1$};
  \node [below=0mm of 2] {$\tau_2+\delta_2$};
