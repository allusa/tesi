\begin{tikzpicture}
  ...
  %R0
  \node[circle,draw,minimum width=2 cm] (R0d) {$\delta_{1}$};
  ...
  %R1
  \node[circle,draw,minimum width=2 cm] (R1d) [right=of R0d] {$\delta_{2}$};
...
\begin{tikzpicture}
 ...
 %R1 d2 k4 tau0 f-1
  ...
  \node[rectangle,draw,minimum width=6*\ut cm] (R1d) [left=\ut cm of R1.center, anchor=east] {$\glssymbol{not:sgstm:lapseR}(R_2)$};
  ...
  \node[rectangle,draw,minimum width=4*\ut cm] (R0d) [left=0 cm of R0.center, anchor=east] {$\glssymbol{not:sgstm:lapseR}(R_1)$};
\end{tikzpicture}
