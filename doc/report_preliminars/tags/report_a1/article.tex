...
\usepackage{fancyhdr}\pagestyle{fancyplain}\chead{--- draft report \today\ ---}\lhead{}\rhead{}\renewcommand{\headrulewidth}{0pt}
%----------------------------------------------
...
\usepackage[bookmarks,pdfborder={0 0 0},pdfusetitle,
    ...
    pdfkeywords={time series; data acquisition; Time series DBMS; MTSMS model; DBMS RRDtool},
    pdflang=en,
    ]{hyperref}
\title{Design preliminaries for a multiresolution time series database management system model}
