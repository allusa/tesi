...
a on s'apliquin. De fet aquest és l'objectiu principal de definir-ne
...
d'una regular, s'han d'utilitzar operadors de funció temporal. És a
dir, la tècnica de regularitzar es basa fortament en les funcions de
representació (v.\ sec.~\ref{sec:model:repr}).

Així, com ja s'ha notat en les propietats del mateix operador i que
ara podem clarificar amb el vocabulari de sèries temporals regulars,
la selecció temporal d'una sèrie temporal en un conjunt de temps
