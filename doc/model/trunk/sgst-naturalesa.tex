...
increments, és a dir la interpolació lineal del comptatge absolut com
si el comptador fos una magnitud.

A la \autoref{fig:model:comptador-formes:relatiu} també es mostra
...
cada lectura s'inicialitza de nou el valor acumulat del comptador. A
la \autoref{fig:model:comptador-formes:velocitat} es mostra la sèrie
temporal $S_v$ \todo{} els pendents lineals del gràfic de valor relatiu, és a
dir la velocitat mitjana de comptatge a cada període.

El significat del gràfic de valor absolut i el d'increments es
visualitza bé en un gràfic de barres \autoref{fig:model:comptador-formes:barres} en el que l'eix vertical mostra
...
d'histograma  \autoref{fig:model:comptador-formes:histograma} en el que l'eix vertical mostra densitat de freqüència i en el
