...
temporal com a relació seguint el concepte de possibles
...
\begin{definition}[Representació canònica]
  ...
  modelada com a relació s'escriu com $S = ( \{t: \bar{\mathbb{R}}, v:
...
\dotsc, (t_k,v_k) \}$, la qual es correspon amb el model de conjunts
inicial.
...
\begin{definition}[Representació multivaluada]
  ...
  v: V \}, \{ \} )$ a on el domini de l'atribut valor és el tipus
...
una sèrie temporals multivaluada. \todo{citar formes normals de les relacions [Date]}
...
valor 1 en el temps 5, la mesura de valor 3 en el temps 7 i la mesura
de valor 1 en el temps 10. 

En la forma canònica completa s'escriu com $S_1 = ( \{t:
\bar{\mathbb{R}}, v: \bar{\mathbb{R}}\}, \{ \{t:5,v:1\}, \{t:7,v:3\},
\{t:10,v:1\} \} )$. També es pot escriure de manera simplificada com a
$S_1 = \{ (5,1), (7,3), (10,1) \}$.
...
atributs de valors on cadascun pertany a $\bar{\mathbb{R}}$.  Conté
el caràcters $a$, $c$ i $a$ mesurats respectivament en els temps $2$,
$3$ i $6$.

Conté el caràcters $a$,
$c$ i $a$ mesurats respectivament en els temps $2$, $3$ i
$6$. 
...
repensar si vector i multivaluat ha de ser el mateix o representen coses diferents: 
...
\paragraph{Exemple 4} \emph{Valors vectors}.
Sèrie temporal $S_4$ on el temps pertany a $\bar{\mathbb{R}}$ i el valor pertany a  $\bar{\mathbb{R}}^3$; és a dir és un vector. Conté el valor (1,2,3) en el temps 2, el valor (3,4,5) en el temps 4 i el valor (1,2,3) en el temps 6.

De manera simplificada s'escriu com $S_2 = \{ (5,(1,2,3)),
(7,(3,4,5)), (10,(1,2,3)) \}$ i es visualitza com a taula i com a
