...
\section{Introducció als conceptes generals}
...
aleshores els \gls{SGBD} s'usen com a eines per a modelitzar la
realitat, és a dir en el procés de dissenyar un model que aproximi i
simplifiqui una realitat. Cal no confondre la definició del model
formal matemàtic amb la interpretació del model en una realitat
concreta.
...
En l'àmbit dels \gls{SGST} i els \gls{SGSTM}, els models descriuen
