...
* Definir base de dades? Potser posar definició següent però precisar que nosaltres ens centrem en la teoria dels sistemes d'informació, segons el model relacional, per a proposar un model lògic deixant de banda els aspectes més d'implementació informàtica de com accedir o manipular físicament les dades

Ara bé cal destacar de la definició que apareix la paraula estructura i organitzada: "Conjunt de dades organitzades segons una estructura coherent"
...
Definició
Conjunt de dades organitzades segons una estructura coherent i accessibles des de més d'un programa o aplicació, de manera que qualsevol d'aquestes dades pot ésser extreta del conjunt i actualitzada, sense que això afecti ni l'estructura del conjunt ni les altres dades. 
