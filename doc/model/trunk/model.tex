...
\begin{definition}[Unió temporal de $S_1$ i $S_2$ amb representació
  ...
  \]
  \[
  S_1 = \{m_0^1 , \ldots , m_k^1\}  \times S_2 = \{m_0^2 , \ldots , m_k^2\} \times r \longrightarrow S'
  \]
  \[
...
Abans pot fer falta fer una selecció dels discs Round Robin amb el mateix interpolador.
