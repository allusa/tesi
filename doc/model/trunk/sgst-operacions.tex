...
sintetitzar per grups, és a dir per a aplicar \emph{aggregate} a
conjunts que prèviament s'han agrupat segons un atribut compartit.
Per a les sèries temporals, però, necessitem una operació
computacional més genèrica que ens permeti calcular recursivament
sense haver de definir grups.
...
\todo{revisar, símbols f diferents per a cada cas}
...
commutativa perquè llavors l'ordre dels càlculs és important. Es pot
