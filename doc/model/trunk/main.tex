...
\usepackage[bookmarks,pdfborder={0 0 0},pdfusetitle,
    ...
    %pdfcreator={},
    pdfsubject={SGSTM (MTSMS)},
    pdfkeywords={sèries temporals; adquisició de dades; SGBD per a sèries temporals (SGST); model SGST multiresolució},
    pdflang=ca,
    ]{hyperref}
