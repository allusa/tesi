...
\todo{Atenció!: la definició d'esquema multiresolució s'ha fet al model estructural}
...
\todo{substituir per la referencia a la def def:sgstm:esquema}
L'esquema de multiresolució de
cada sèrie temporal multiresolució consisteix en quatre paràmetres: el darrer instant de consolidació ($\tau$), el pas de
