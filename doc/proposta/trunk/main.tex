...
\hypersetup{
    ...
    pdfkeywords={sèries temporals; SGBD per a sèries temporals; SGST; dades temporals; adquisició de dades},
    pdflang=ca,
}
\title{Model pels sistemes de gestió de sèries temporals}
