...
%--------------------
\documentclass[paper=a4,fontsize=10pt,twoside,parskip=half,BCOR-0.5mm,openany,DIV = 10]{scrbook}
...
\title{Disseny i modelització d'un sistema de gestió multiresolució de sèries temporals}
