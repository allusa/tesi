...
\item[9.] Redacció d'articles i informes. Un cop s'hagi completat el
  ...
  % \todo{} Cal fer una tasca intensa de recerca de revistes i
  % congressos que siguin afins a l'àmbit on treballem. La tasca de
  % redacció d'un article comporta una gran feina que haurem de
  % justificar en el proper informe.
