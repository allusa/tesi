...
El monitoratge es pot dividir en diferents blocs principals.
%, els quals es mostren a la \autoref{fig:sistema_monitoratge}. 
...
%La \autoref{fig:sistema_monitoratge} presenta 
