...
\begin{abstract}
  ...
  presentat el 2012 i actualitzat el 2013 per a assolir la recerca en
  el disseny d'un model de sistema de gestió per a sèries
  temporals. En primer lloc es presenta l'actualització dels
  objectius, en segon lloc el progrés en funció de les tasques
  planificades realitzades i en tercer lloc l'ampliació del pla de
  treball per a assolir els objectius pendents.
\end{abstract}
