...
one sensor.  \todo{explicar pel·lícula}
...
observations\todo{note that we could use a non filling aggregate such
  as a unknown marking function}, and the number of stored values has
...
\begin{figure}[tp]
\centering
\includegraphics[width=12cm]{\experiment/isense4.pdf}
