...
\begin{figure}[tp]
  \begin{center}
    ...
    \begin{tikzpicture}[node distance=0.5cm]  
      ...
      \node[mynode, below right=0.5cm and 1cm of monitor]  (bd)        {DBMS};

      \node[mynode, groc, below right=2cm and -2cm of monitor] (supervisor)    {Supervisor};   

      \node[mynode, below=2cm of monitor, left=2cm and 2cm of supervisor]     (control)   {Controllers}; 


      \node[mynode, roig, below right=0.5cm and 4cm of monitor] (usuari)    {User};  
      \node[mynode, verd, left=1.2cm of control]            (actuador)  {Drives};
      \node[mynode, verd, left=4cm of monitor]            (sensor)    {Sensors}; 
      ...
      \draw[myarrow] (bd.east) --   (usuari.west)
    ...
    \draw[myarrow] (usuari.south) --   (supervisor.east)	
