...
into arrays in order to achieve multidimensional analysis. %scidb barreja relacions i arrays d'una manera estranya que embolica més que tneir-ne uns o els altres %A més sciql ofereix exempes per sèries temporals per algunes de les seves propietats: regularitat, interpolació i cerca de correlacions.
