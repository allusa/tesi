...
However, TSMS properties have not been further investigated as research has concentrated on data mining tasks. As instance, \textcite{last01} notes the existence of the TSMS data model but studies a general methodology for the knowledge discovery in TSMS: data cleaning and preprocessing, data mining, and postprocessing of discovered patterns. %Last01: TSMS discovering temporal patterns (groups of events ordered by time) and temporal rules (cause-effect relationships between events).
