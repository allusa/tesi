...
%v1.6     restrict y to domain=0:320,
       ...
       \addplot[const plot mark right, blue, mark=*] table[col sep=comma] {dades/mrdb2-matriu0/3.csv};
       \addlegendentry{mean};

       \addplot[const plot mark right, orange, mark=*] table[col sep=comma] {dades/mrdb2-matriu0/4.csv};
       \addlegendentry{max};
