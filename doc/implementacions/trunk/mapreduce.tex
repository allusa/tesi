...
($O$), les d'entremig ($E$) i les finals ($F$), i finalment definim
l'operació de map i la de reduce.
...
\todo{s'ha d'explicar més com són
  aquestes dades, potser comentar-ho a través de l'exemple de la shell} 
