...
consideracions de Date\todo{referència} sobre l'allunyament del
llenguatge SQL respecte del model relacional, s'implementa amb
Tutorial D\todo{referència, third manifesto?}: el llenguatge acadèmic dels SGBDR.  Com a
intèrpret per a aquest llenguatge s'utilitza Rel\todo{referència}
