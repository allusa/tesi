...
\cite{date}.  Disposar d'un model per a RRDtool, permetrà aprofundir
en aquests tipus de SGBD's i estudiar com poden ajudar, per exemple,
en l'aplicació de mètodes de validació i predicció com els que proposa
Puig \emph{et al.} o les reduccions de dimensió que proposen Camerra i
Keogh.
