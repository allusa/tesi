...
SGBD SQL com per exemple el cas NoSQL de MapReduce esperona el NewSQL
...
tipus relació de parentiu (\emph{relationship}). Finalment, cal
destacar que, tot i aquests nous productes, els SGBD SQL tradicionals
encara són el més usats perquè en moltes aplicacions segueixen sent
l'opció més eficient.  A més, el model relacional té molt prestigi
