...
It should be remarked that the only goal of the model introduced here
...
multiresolution.  Previously to this paper's complete formalisation
for the \acro{MTSMS} model, we analysed the requirements and an
overall vision for multiresolution systems \cite{llusa13:aiked}.
