...
\begin{frontmatter}
  ...
  \begin{abstract}
    ...
    achieve online computed queries and visualisations.
    
    We design a referent implementation of the model. It has academic
    purposes but also we use it to compute multiresolution examples
    with real data.
  \end{abstract}
