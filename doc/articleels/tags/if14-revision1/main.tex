...
\begin{frontmatter}
  ...
  \begin{abstract}
    ...
    series to be compactly stored consuming a finite capacity while
    ...
    can be a challenge in the multiresolution approach.  We use the
    time-order acquisition characteristic of time series to simplify
