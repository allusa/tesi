...
\begin{frontmatter}
  ...
  \begin{abstract}
    ...
    customize it according to the actual requirements of a given
    context.
    %
    All the model pieces that hold a semantical meaning dependant on
    the actual application remain parametrizable.

    In this paper we offer a formalisation of the model built upon set
    theory and heavily inpired on relational database theory.
    %
