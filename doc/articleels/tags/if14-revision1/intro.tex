...
chronologically.  In general, time series come from a continuously 
\todo{clarificar}
...
only the needed data. The concept is similar to multimedia
lossy compression methods, where data can be discarded in
