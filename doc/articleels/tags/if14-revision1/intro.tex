...
relational algebra \todo{comentari:not only based} as a formal theory
...
\todo{report explicitily: no similar formalism has been undertaken by
  other. However, it is interesting to note some other approaches when
  treating time series. Specially some multiresolution features can be found in other works }
