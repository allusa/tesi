...
\acro{MTSMS} model. Furthermore, each \texttt{Buffer} is associated to
...
\texttt{f}. The method \emph{totalseries} returns the \emph{TimeSeries} that
results from the concatenation of all \emph{seriedisc} sorted by
\emph{delta}.
