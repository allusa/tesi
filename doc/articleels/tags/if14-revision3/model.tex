...
$f:\mathcal{T}\rightarrow\cal{V}$.  In some sense, we can think that a
time series is the discretization of some temporal representation
funcion.
...
an unique temporal representation function for $S$.

We denote as $S(t)^r$ the temporal representation function of $S$
obtained by applying the method $r$.
