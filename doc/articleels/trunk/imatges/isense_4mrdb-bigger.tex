  ...
  \begin{tikzpicture}
    \begin{axis}[
       ...
       \addplot[const plot mark right, blue] table[col sep=comma] {dades/mrdb2-matriu0/0.csv};
  \end{axis}
\end{tikzpicture}
  ...
  \begin{tikzpicture}
    \begin{axis}[
       ...
       \addplot[const plot mark right, blue] table[col sep=comma] {dades/mrdb2-matriu0/1.csv};
  \end{axis}
\end{tikzpicture}
  ...
  \begin{tikzpicture}
    \begin{axis}[
       ...
       \addplot[const plot mark right, blue] table[col sep=comma] {dades/mrdb2-matriu0/2.csv};
  \end{axis}
\end{tikzpicture}
\begin{tikzpicture}
    \begin{axis}[
...
%v1.6     restrict y to domain=0:320,
       ...
       \addplot[const plot mark right, blue] table[col sep=comma] {dades/mrdb2-matriu0/3.csv};
       \addlegendentry{mean};

       \addplot[const plot mark right, orange] table[col sep=comma] {dades/mrdb2-matriu0/4.csv};
       \addlegendentry{max};
