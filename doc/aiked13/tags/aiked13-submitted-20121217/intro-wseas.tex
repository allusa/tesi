...
This paper is organised as follows.  In Section~\ref{sec:related-work}
...
is formalised following: nomenclature preliminaries are introduced in
Section~\ref{sec:model:preliminaries}, data structure is formulated in
Section~\ref{sec:MTSMS}, and attribute aggregate is summarised in
Section~\ref{sec:model:interpolador}. Section~\ref{sec:example} shows
a multiresolution database example for real data. Finally,
