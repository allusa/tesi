...
a \acro{RDBMS} as a time series back-end suffers of some drawbacks,
...
\acro{TSMS} are presented and a summary of its features is shown in
Section~\ref{sec:tsms-features}.  The \acro{MTSMS} model is formalised
...
a phenomena evolution along time. As a result, \acro{TSMS} operations
