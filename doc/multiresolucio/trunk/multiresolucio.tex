...
\begin{example}[Mateixa consulta i funció d'agregació d'atributs]
  Sigui $S=\{m0,\dotsc,m_k\}$ una sèrie temporal i $e= \{ (\delta_0,
  f_0, \tau_0, k_0) \}$ un esquema de multiresolució amb una sola
  subsèrie resolució, suposem $k_0=\infty$ per tal de menysprear-ne
  l'efecte i $\tau_0=T(min(S))$. Obtenim la sèrie temporal resultant
  d'aplicar la funció de multiresolució
  ...
  $\delta_0$ $S'=\{ f(S,[\tau_0,\tau_0+\delta_0],
  f(S,[\tau_0+\delta_0)\dotsc f(S,\tau_0+2\delta_0])\dotsc \}$.

  Apliquem un operador de consulta $o$ a les dues sèries temporals,
  $r_1=o(S,[-\infty,\infty])$ i $r_2=o(S',[-\infty,\infty])$, que és
  la mateixa funció d'agregació d'atributs de la multiresolució
  $o=f_0$. Analitzem els efectes segons diferents funcions d'agregació
  d'atributs: mitjana, màxim i total.
