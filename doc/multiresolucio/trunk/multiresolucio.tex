...
\chapter{Esquemes de multiresolució aplicats als SGST}
...
En conclusió, encara que l'objectiu final sigui l'emmagatzematge de les sèries
...
escollir i eliminar-los un cop es consideri que l'esquema és
...
aproximades.%
A la \autoref{fig:multiresolucio:comparacio-propietats} es mostra una
taula que resumeix les propietats descrites dels \gls{SGST}, dels
\gls{SGSTM} i dels \gls{SGST}+\gls{SGSTM}, on es comparen segons si
les compleixen (S) o si no les compleixen (N).
...
\todo{}
Paraula clau: consultes aproximades?

Estudiar l'aplicació de la teoria de la informació per a
