...
\subsection{Avaluar la multiresolució}
...
\subsection{Problema d'informació de la multiresolució}
...
temporal multiresolució puc consultar la sèrie temporal total
...
és l'esquema de $M$.  Executo una operació de consulta $o$ sobre la
sèrie temporal original $r_1=o(S)$ i la mateixa operació sobre la
sèrie temporal de la multiresolució $r_2=o(S')$ . Puc avaluar l'error
...
Es pot avaluar $d(S,S')$, però aquest no és el problema que intenten resoldre els \gls{SGSTM}. Els \gls{SGSTM} resolen un problema de compressió amb pèrdua i aquest seria un problema d'aproximació al senyal original, el qual altres models poden resoldre més bé\todo{ref?}.  
