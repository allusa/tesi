...
class RRD(set):
    ...
    False
    >>> M
    RRD([RD:Buffer(SerieTemporal([m(10,1), m(10,2), m(40,5)]),0,10),Disc(SerieTemporal([]), |4|), RD:Buffer(SerieTemporal([]),5,5),Disc(SerieTemporal([m(20.0,5)]), |2|)])
    >>> M.update(m4)
    >>> M.consolidable()
    True
    >>> M.consolida()
    ...
    False
    >>> M
    RRD([RD:Buffer(SerieTemporal([]),10,10),Disc(SerieTemporal([m(27.5,10)]), |4|), RD:Buffer(SerieTemporal([]),10,5),Disc(SerieTemporal([m(20.0,5), m(50.0,10)]), |2|)])
    >>> M.update(m5)
    >>> M.consolidable()
    True
    >>> M.consolida()
    ...
    False
    >>> M
    RRD([RD:Buffer(SerieTemporal([m(10,15)]),10,10),Disc(SerieTemporal([m(27.5,10)]), |4|), RD:Buffer(SerieTemporal([]),15,5),Disc(SerieTemporal([m(50.0,10), m(10.0,15)]), |2|)])
    """
